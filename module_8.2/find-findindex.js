...
function findUserByUsername(usersArray, username) {
  return usersArray.find((object) => {
    if (object.username.toLowerCase() == username.toLowerCase()) return true
  })
}

/*
Write a function called `removeUser` which accepts an array of objects, e
ach with a key of username, and a string. 
...
function removeUser(usersArray, username) {
  let ans = usersArray.find((object, idx) => {
    if (object.username.toLowerCase() === username.toLowerCase()) {
